...
#ifndef POLICE_MPEG4_WRITER_H_

#define POLICE_MPEG4_WRITER_H_
...
class PoliceMPEG4Writer : public MediaWriter {
public:
    PoliceMPEG4Writer(int fd);
	...
	//virtual status_t setEncryptEnable(bool flag);
...
private:
    ...
    PoliceMPEG4Writer(const PoliceMPEG4Writer &);
    PoliceMPEG4Writer &operator=(const PoliceMPEG4Writer &);
};
